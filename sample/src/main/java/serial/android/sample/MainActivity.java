...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadPorts() {
        ...
        Log.e("cantidad",ports.length+"");
        for (PortInfo item:ports) {
            Log.e("puertoss","description: "+item.description+ ", hardwareId: "+item.hardwareId+ " port: "+item.port+ " strinng "+item.toString());
        }
